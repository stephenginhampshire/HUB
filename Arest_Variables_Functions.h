...
// Expose variables to rest --------------------------------------------------------------------------------------------------------------
  ...
  rest.variable("Azimuth", &Azimuth_value);											// v4
  rest.variable("Slewing", &Slewing_value);											// v5
  rest.variable("TargetAltitude", &TargetAltitude_value);								// v6
  rest.variable("TargetAzimuth", &TargetAzimuth_value);								// v7
  rest.variable("Tracking", &Tracking_value);											// v8
  rest.variable("TrackingRateAzimuth", &TrackingRateAzimuth_value);					// v9
  ...
  // ASCOM functions exposed to rest
  {
	  ...
	  rest.function("HubDisplay_On", Hub_Display_On_f);							// fa16
	  rest.function("HubDisplay_Off", Hub_Display_Off_f);							// fa17
